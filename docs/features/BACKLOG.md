...
| — | **foreign-designer-lane** (дизайн модулей ченджа для foreign: новая роль `@foreign-designer`/Parnas — module-tree+contracts+C4+ADR в conform, чтобы фичу проектировать качественно) | 🔴 P0 | ⏳ эпик оформлен (F1–F5); строгий moduledesigner нетронут | [foreign-designer-lane.md](./foreign-designer-lane.md) |
