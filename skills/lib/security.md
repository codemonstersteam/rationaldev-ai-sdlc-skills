...
**Применяется на:** PLANNING (Planner закладывает требования безопасности как требование плана), PLAN REVIEW, IMPLEMENTATION, CI (отдельный security-scan).
**Цель:** агент учитывает требования безопасности на этапе плана и реализации, а не постфактум; статика в CI ловит остальное.
