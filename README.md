...
> Дерзкий стартаперский цикл разработки ПО на базе агентов: команда — **человек + машина**.
...
> **Подключить как мультиагентный харнес** (Claude / Codex / OpenCode) — одной командой:
> **[`docs/story-harness/README.md`](docs/story-harness/README.md)** (быстрый старт + матрица установки).
...
## Дерзкий стартап: чего НЕТ и что есть
