...
- [ ] **🟠 anti-loop guard.** Qwen-hughes на конфликте типа ушёл в петлю дословного повтора reasoning без outputs.
  Детект «нет outputs + повтор / превышен step-budget» → abort субагента → @linger/split.
