// Чистые ядра готовности плана к Gate #1 (io: none): hasChorePlan + planReadyForApproval
// с durable chore-планом.
...
test("planReadyForApproval: plan-review.md = собран (greenfield / SemVer-полоса)", () => {
